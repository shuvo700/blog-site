...
<div class="container-fluid">
    ...
    <!-- Exportable Table -->
    <form action="{{url('author/post/update')}}/{{$post->id}}" enctype="multipart/form-data" method="post">
           {{ csrf_field() }}
            <div class="row clearfix">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="title" name="title" class="form-control" placeholder="Enter your Post Title" value="{{$post->title}}">
                                    </div>
                                </div>
                                ...
                                <input type="checkbox" id="status" name="status" class="filled-in" value="1" {{$post->status==true ? 'checked':''}}>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tags[]" id="post_tags" class="form-control show-tick" multiple>
                                    @foreach($tags as $tag)
                                        <option 
                   ...
                   <div class="card">
                       <div class="header">
                        ...
                        <div class="body">
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="4" id="post_body" class="form-control no-resize" name="body">{{$post->body}}</textarea>
